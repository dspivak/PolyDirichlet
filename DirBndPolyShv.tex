...
%We will later have reason to consider the inclusion
...
\end{tikzcd}
\end{equation}
%where $n$ is shorthand for $n\yon^0$ and $n\mdot1^\yon$, respectively. 
...
%--Joachim said he found this part misleading. You shouldn't have empty rows. And it doesn't have a story for what you usually do with Young diagrams, decreasing order, you subtract them, etc.
%\begin{remark}
