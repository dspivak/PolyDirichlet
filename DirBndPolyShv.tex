...
In this note we also show that there is a double category whose vertical morphisms are polynomial maps and whose horizontal morphisms are Dirichlet maps.
\end{abstract}
