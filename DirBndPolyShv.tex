...
\end{tikzcd}
\end{equation}
All six of the displayed functors out of $\fin$ are fully faithful. For each $k:\fin$ the functors $P\mapsto P(k)$ and $D\mapsto D(k)$ have left adjoints, namely $n\mapsto n\yon^k$ and $n\mapsto n\mdot k^\yon$ respectively.
...
Thanks to Joachim Kock, Andr\'{e} Joyal, and Brendan Fong for helpful comments that improved the quality of this note.
