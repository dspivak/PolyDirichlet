...
In this note we also prove some very basic theorems, e.g.\ that the category of \emph{finite} Dirichlet series is equivalent to the category $\finset^{\to}$ of functions $\pi\colon s\to t$ between finite sets. An analogous theorem holds for $\smset$.
\end{abstract}
