...
\]
Finally, there are adjoint triples where the four functors out of $\smset$ are fully faithful:
\[
\begin{tikzcd}[column sep=50pt]
  \smset\ar[r, shift left=12pt, "n\mapsto n\yon^0"]\ar[r, shift right=12pt, "n\mapsto n\yon^1"']&
  \poly\ar[l, "\;-(1)\;" description]\ar[l, phantom, shift left=6pt, "\Rightarrow"]\ar[l, phantom, shift right=6pt, "\Leftarrow"]
\end{tikzcd}
\hspace{1in}
\begin{tikzcd}[column sep=50pt]
  \smset\ar[r, shift left=12pt, "n\mapsto n\cdot 0^\yon"]\ar[r, shift right=12pt, "n\mapsto n\cdot1^\yon"']&
  \dir\ar[l, "\;-(0)\;" description]\ar[l, phantom, shift left=6pt, "\Rightarrow"]\ar[l, phantom, shift right=6pt, "\Leftarrow"]
\end{tikzcd}
\]
\end{remark}
...
\inote{Jaz, would you mind doing this section?}
