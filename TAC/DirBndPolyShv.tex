...
% biblatex %
%  \addbibresource{Library20200310.bib} 
...
\author{David I.\ Spivak\quad and\quad David Jaz Myers}


\address{MIT; Department of Mathematics; 77 Massachusetts Ave.\ Cambridge MA 02139}
\eaddress{dspivak@gmail.com}
\keywords{Dirichlet series, Polynomial functor, topos, bundle, container}
\amsclass{18B25, 18M80}
...
If one allows \emph{arbitary} sums of functors represented by finite sets, one gets \emph{analytic} functors in the covariant case---first defined by Joyal in his seminal paper on combinatorial species \cite{joyal1981species}---and \emph{Dirichlet} functors in the contravariant case---first defined by Baez and Dolan and appearing in Baez's \emph{This Week's Finds} blog \cite{baez300}. Baez and Dolan also drop the traditional negative sign in the exponent (that is, they use $n^s$ where $n^{-s}$ usually appears), but also find a nice way to bring it back by moving to groupoids. Here, we drop the negative sign and work with finite sets to keep things as simple as possible. Similar considerations hold with little extra work for infinite Dirichlet series or power series, and even more generally, by replacing $\fin$ with $\smset$. 
...
\section{Polynomial and Dirichlet functors}
...
\section{The categories $\poly$ and $\dir$}
...
\section{$\poly$ and $\dir$ in terms of bundles}\label{chap.poly_dir_bund}
...
One may note that $\bun$ is the Grothendieck construction of the self-indexing $\fin_{/(-)} \colon \fin\op \to \smcat$, while $\cont$ is the Grothendieck construction of its point-wise opposite $(\fin_{/(-)})\op \colon \fin\op \to \smcat$.
 ...
 The name \emph{container} comes from the work of Abbot, Altenkirch, and Ghani \cite{abbot2003categoriesthesis,abbott2005containers,abbott2003categories} (see Remark 2.18 in \cite{kock2012polynomial} for a discussion of the precise relationship between the notion of container and the notion of polynomial and polynomial functor).
...
%
%
%We first note that a natural transformation $\phi\colon D \to D'$ between Dirichlet functors is cartesian if and only if the naturality square induced by $!X\colon 0 \to X$
%
...
%\section{The $\poly-\dir$ double category $\ff$}
%
...
Given a combinatorial species $A\colon \fin^{\cong} \to \smset$, its
\emph{Cauchy generating functor} $X \mapsto \sum_{n\colon \fin} A_n \times X^n/n!$
...
\sum_{n\colon \fin} A_n n^S/n!$ is the left Kan extension of $A$ along the
...
convolution from $+\colon \fin^{\cong} \times \fin^{\cong}$, and
...
given by Day convolution from $\times\colon \fin^{\cong} \times
...
\bibitem{abbot2003categoriesthesis} Michael Gordon Abbott. “Categories of Containers”. PhD thesis. University ofLeicester, Aug. 2003.

\bibitem{abbott2005containers} Michael Gordon Abbott, Thorsten Altenkirch, and Neil Ghani. “Categories ofContainers”. In: FoSSaCS. 2003.

\bibitem{abbott2003categories} Michael Abbott, Thorsten Altenkirch, and Neil Ghani. “Containers: Constructingstrictly positive types”. In: Theoretical Computer Science 342.1 (2005). AppliedSemantics: Selected Topics, pp. 3–27.

\bibitem{baez300} John Baez and James Dolan. This Week’s Finds 300. Accessed: 2020-02-16. \url{http://math.ucr.edu/home/baez/week300.html}

\bibitem{kock2012polynomial} Nicola Gambino and Joachim Kock. “Polynomial functors and polynomial monads”.In: Mathematical Proceedings of the Cambridge Philosophical Society 154.1 (Sept.2012), pp. 153–192. 

\bibitem{joyal1981species} André Joyal. “Une théorie combinatoire des séries formelles”. In: Advances inMathematics 42.1 (1981), pp. 1–82. 

\bibitem{rosebrugh1994adjoint} Robert Rosebrugh and R.\ J.\ Wood. “An Adjoint Characterization of the Categoryof Sets”. In: Proc. Amer. Math. Soc 122 (1994), pp. 409–413.
